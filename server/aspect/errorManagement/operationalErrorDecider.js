...
//many packages throw non-classified errors though it's hard to determine whether the error is safe/operational
//this place allow to run those decision rules
function operationalErrorDecider() {
    ...
    this.getAllRules = function () {
        ...
        //TODO - check error that coming from mongoDB driver
