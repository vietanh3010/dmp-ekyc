      ...
      <div className="animated fadeIn">
        <div className="card">
          <div className="card-header">
            <span className="h4 text-uppercase">Thông Tin Siêu Người Dùng</span>
          </div>
          <div className="card-body">
            <Form>
              ...
              <div className="card">
                <div className="card-header">
                  <span className="h6">Danh Sách Người Dùng</span>
                </div>
                <div className="card-body">
        ...
        <p className="text-center">
          <Link to={`/superuser/view/`} className="btn btn-primary mr-1">Về danh sách siêu người dùng</Link>
        </p>
      </div>
    )
  }
